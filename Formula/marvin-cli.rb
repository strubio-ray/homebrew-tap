class MarvinCli < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/strubio-ray/marvin-cli/releases/download/v#{version}/marvin-cli_v#{version}_darwin_arm64.tar.gz"
      sha256 "21c8e0e0d5fbedaa4f2c3bca89e117f10b6cb029c4d38536c4e0fa14df1963b7"
    end
    if Hardware::CPU.intel?
      url "https://github.com/strubio-ray/marvin-cli/releases/download/v#{version}/marvin-cli_v#{version}_darwin_amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/strubio-ray/marvin-cli/releases/download/v#{version}/marvin-cli_v#{version}_linux_amd64.tar.gz"
